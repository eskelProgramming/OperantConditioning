...
## The ending position for the character
@export var end_pos: Node2D
## The speed at which the character moves between positions
@export var move_speed: float = 20.0

## Internal variables

## Stores the global positions of the start and end nodes
var target_positions: = [Node2D]
